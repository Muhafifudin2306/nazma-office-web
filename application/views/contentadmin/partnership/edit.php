...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>Edit New Partnership</h1>
        </div>
        <div class="section-body">
            <div class="row">
                <div class="col-12">
                    <form method="POST"
                        action="<?= site_url() ?>admin/partnership/editPartnership/<?= $partnershipDetail->id ?>"
                        enctype="multipart/form-data">
                        <div class="card">
                            <div class="card-header">
                                <a href="<?= site_url('admin/partnership') ?>" class="btn btn-primary">Back</a>
                            </div>
                            <div class="card-body">
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-3 col-form-label">Photo</label>
                                    <div class="col-sm-9">
                                        <?php if ($partnershipDetail->photo) { ?>
                                            <span>
                                                <a href="<?= base_url() ?>admin/partnership/getFile/photo/<?= $partnershipDetail->id ?>"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="name" class="form-control"
                                            value="<?= $partnershipDetail->name ?>" placeholder="Input Name">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="departement" class="form-control"
                                            value="<?= $partnershipDetail->departement ?>"
