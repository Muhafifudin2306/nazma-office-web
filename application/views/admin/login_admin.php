...
<body>
                ...
                <div class="row">
                    <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                        <div class="login-brand">
                            <img src="<?= base_url() ?>assets/img/NaZMa_Logo_Transparent.png" alt="logo" width="100" class="shadow-light rounded-circle">
                        </div>
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                <form method="POST" action="<?= site_url('admin/auth/login_action'); ?>" class="needs-validation" novalidate="">
                        ...
                        <div class="simple-footer">
                            Copyright &copy; NaZMa Office <?= date('Y'); ?> | Template By <a href="https://github.com/stisla/stisla">Stisla</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script src="<?= base_url() ?>assets/admin/stisla/js/stisla.js"></script>
