...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>Edit New Certified Trainers</h1>
        </div>
        <div class="section-body">
            <div class="row">
                <div class="col-12">
                    <form method="POST"
                        action="<?= site_url() ?>admin/certifiedtrainers/editCertifiedtrainers/<?= $certifiedtrainersDetail->id ?>"
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <?php if ($certifiedtrainersDetail->photo) { ?>
                                            <span>
                                                <a href="<?= base_url() ?>admin/certifiedtrainers/getFile/photo/<?= $certifiedtrainersDetail->id ?>"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="name" class="form-control"
                                            value="<?= $certifiedtrainersDetail->name ?>" placeholder="Input Name">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="departement" class="form-control"
                                            value="<?= $certifiedtrainersDetail->departement ?>"
