...
<head>
      ...
      <meta property="og:image" content="<?= base_url() ?>assets/img/NaZMa_Logo_Transparent.png">
      ...
      <!-- external CSS & JS -->
      <link href="<?= base_url('assets/css/front2.css') ?>" rel="stylesheet">
                  ...
                  <div class="container">
                        ...
                        <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                              <ul class="navbar-nav gap-2">
                                    ...
                                    <li class="nav-item">
                                          <a class="nav-link ft-light" href="#about">Tentang Kami</a>
                                    </li>
                                    <li class="nav-item">
                                          <a class="nav-link ft-light" href="#service">Layanan</a>
                                    </li>
                                    <li class="nav-item">
                                          <a class="nav-link ft-light"
